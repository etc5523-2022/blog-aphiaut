...
date: "2022-09-01"
categories: ["Economics", "Analysis", "Women"]
...
@fig-median_income illustrates the median income between males and females from 1980 to 2020. It can be seen gaps between males and females are quite wide, however, the gap is likely to decrease in the future.
...
@fig-median_vs_women represents the average median income versus the percentage of women in each major category. It shows women can work in the engineering category, which is the highest median income of the categories, only 24%. While the psychology and social work category which is the lowest median income of the categories, and the health category has a share of women of around 80 percent. However, both categories are directly important to humans, there is a slight proportion for men.
